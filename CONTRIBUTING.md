...
Welcome to `reflow` contributor's guide.
...
If you experience bugs or general issues with `reflow`, please have a look
...
You can help improve `reflow` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`reflow` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `reflow`'s files. While this mechanism can
...
```
conda create -n reflow python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/reflow.git
   cd reflow
   ```
...
5. Install [pre-commit]:
   ...
   `reflow` comes with a lot of hooks configured to automatically help the
